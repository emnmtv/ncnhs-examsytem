  ...
  <div class="student-profile">
    ...
    <div v-else class="profile-container">
      ...
      <div class="profile-details">
        ...
        <div class="profile-section">
          ...
          <div class="info-group">
            ...
            <span>{{ profile.gradeLevel || 'Not set' }}</span>
          </div>
          <div class="info-group">
            <label>Section:</label>
            <span>{{ profile.section || 'Not set' }}</span>
          </div>
        </div>
      ...
      <div v-if="isEditing" class="edit-form">
        ...
        <div class="form-group">
          <label>Grade Level:</label>
          <input v-model.number="profile.gradeLevel" type="number" />
        </div>
        <div class="form-group">
          <label>Section:</label>
          <input v-model="profile.section" type="text" />
        </div>
      </div>
    </div>
  </div>
